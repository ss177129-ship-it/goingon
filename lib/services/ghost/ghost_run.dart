...
//
// **GPS 경로는 담지 않는다.** 재생이 시간축 기반이라 경로가 필요 없고,
// 담지 않으면 위치정보 규제 부담도 사라진다. 상대가 어디서 뛰었든 나는 내
// 동네에서 그날의 리듬과 함께 뛴다 — 그것이 "멀리 있어도"의 기술적 실체다.
import '../cadence/partner_cadence.dart';

/// 누가 이 고스트와 달릴 수 있는가. **기본은 페이스메이트만.**
///
/// 기본값을 좁게 잡은 것은 되돌리기 비용 때문이다 — 좁은 기본값은 나중에
/// 넓힐 수 있지만, 넓은 기본값으로 이미 공개된 기록은 되돌릴 수 없다.
