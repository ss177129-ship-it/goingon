...
class ResonanceThresholds {
  ...
  /// 공명 진입 — 옛 프로토타입의 `sync>.93`보다 낮게 잡았다.
  ...
  /// 공명 **진입에 필요한 지속 시간** — |Δ케이던스| ≤ 3spm 상태가 8초 지속.
  ///
...
///
/// **셋을 넘지 않는다.** 달리면서 네 번째를 기억하지 못한다. 옛 프로토타입
/// 에는 넷이 있었지만(파이팅·보고싶어·빨라지자·천천히)
