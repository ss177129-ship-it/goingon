...
//
// **주의: 이 프로브를 돌리면 기기·시뮬레이터의 실제 앱이 덮어써진다.**
// 번들 ID가 같아서(com.chanwoong.goingon) 홈 화면의 'Goingon'을 눌러도
// 이 진단 화면이 뜬다. 실제로 한 번 이렇게 혼란을 겪었다(2026-08-16).
// 확인이 끝나면 반드시 실제 앱을 다시 설치할 것:
